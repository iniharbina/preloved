...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong><a>Noviara Preloved</a></strong>
  </footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{asset('lte/plugins/jquery-ui/jquery-ui.min')}}"></script>
...
<!-- ChartJS -->
<script src="{{asset('lte/plugins/chart/Chart.min')}}"></script>
<!-- Sparkline -->
